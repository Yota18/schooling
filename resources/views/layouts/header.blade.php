<div class="main-header">
    ...
    <div class="logo-header" data-background-color="blue">
        <a href="{{ route( \Request::segment(1).'.dashboard') }}" class="logo">
            <img src="{{ asset('assets/img-custom/logo.png')}}" alt="navbar brand" class="navbar-brand">
            <span class="tupai">Tupai Tech</span>
        </a>
                        ...
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    ...
                                    <div class="u-text">
                                        <h4>Admin tupai</h4>
                                        <p class="text-muted">admin@tupaitech.net</p><a href="profile.html" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
                                    </div>
                                </div>
                            </li>
                            <li>
