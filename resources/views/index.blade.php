				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Welcome to dashboard admin <span class="text-warning">Tupai tech</span></h2>
								<h5 class="text-white op-7 mb-2">Manage your website quickly and easily</h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
								<a href="#" class="btn btn-secondary btn-round"><i class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Add Customer</a>
							</div>
						</div>
					</div>
				</div>
