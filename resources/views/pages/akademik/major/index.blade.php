                    ...
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                ...
                                <h5 class="text-white op-7 mb-2">Kelola informasi Jurusan.</h5>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="{{ route('akademik.major.add') }}" class="btn btn-secondary btn-round"><i class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Tambah Jurusan</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
				...
				columns: [
					...
					},
					{
						...
						render: function(data, type, row){
							...
							<button class="btn btn-xs btn-danger my-1" id="delete" onclick="delete_data('+data+', \'jurusan\')">Delete</button>';
						}
					},
				]
			});
		...
		function set_switch(id,isactive){
			$.ajax({
				...
				url: '{!! route('akademik.major.switch') !!}',
				dataType: 'JSON',
