                    ...
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                ...
                                <h5 class="text-white op-7 mb-2">Kelola informasi Guru.</h5>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="{{ route('master.users.teacher.add') }}" class="btn btn-secondary btn-round"><i class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Tambah Guru</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
			table =  $('#basic-datatables').DataTable({
				...
				ajax: {
					url : '{!! route('master.users.teacher.data') !!}',
					type : 'POST',
					data: {_token:_token},
				},
				columns: [
		...
		function set_switch(id,isactive){
			$.ajax({
				...
				url: '{!! route('master.users.teacher.switch') !!}',
				dataType: 'JSON',
