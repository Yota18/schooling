                    ...
                    <div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
                                    <form action="{{ route('akademik.users.alumni.update', ['student' => $student->id])}}" method="POST" enctype="multipart/form-data">
										@csrf
                                        @method('put')
                                        <div class="row">
                                        ...
                                        <div class="mt-2 float-right">
                                            <a type="button" href="{{ route('akademik.users.alumni.index') }}" class="btn btn-warning btn-rounded ml-2">Kembali</a>
