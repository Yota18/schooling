                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Kategori Pelajaran </h2>
                                <h5 class="text-white op-7 mb-2">Kelola informasi Kategori Pelajaran.</h5>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="{{ route('akademik.mapel.category.add') }}" class="btn btn-secondary btn-round"><i class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Tambah Kategori Pelajaran</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
			table =  $('#basic-datatables').DataTable({
				...
				ajax: {
					url : '{!! route('akademik.mapel.category.data') !!}',
					type : 'POST',
					data: {_token:_token},
				},
				columns: [
					...
					},
					{
						...
						render: function(data, type, row){
							...
							<button class="btn btn-xs btn-danger my-1" id="delete" onclick="delete_data('+data+', \'mapel/kategori\')">Delete</button>';
						}
					},
				]
			});
		...
		function set_switch(id,isactive){
			$.ajax({
				...
				url: '{!! route('akademik.mapel.category.switch') !!}',
				dataType: 'JSON',
