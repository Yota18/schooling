                    ...
                    <div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
                                    <form action="{{ route('akademik.users.admin.update', ['user' => $user->id])}}" method="POST" enctype="multipart/form-data">
										@csrf
                                        @method('put')
                                        <div class="row">
                                        ...
                                        <div class="mt-2 float-right">
                                            <a type="button" href="{{ route('akademik.users.admin.index') }}" class="btn btn-warning btn-rounded ml-2">Kembali</a>
