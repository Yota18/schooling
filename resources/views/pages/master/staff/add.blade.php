						...
						<div class="col-md-7">
							<div class="card">
                                <div class="card-header card-info">
                                    <div class="card-title">Form tambah Staff</div>
                                </div>
								<div class="card-body">
                                    <form action="{{ route('master.users.staff.store') }}" method="POST"  enctype="multipart/form-data">
										@csrf
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="username" name="username" aria-describedby="username" placeholder="Nama" value="{{ old('username') }}" >
                                        ...
                                        <div class="mt-2 float-right">
                                            <a type="button" href="{{ route('master.users.staff.index') }}" class="btn btn-warning btn-rounded ml-2">Kembali</a>
