                    ...
                    <div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
                                    <form action="{{ route('master.users.student.update', ['student' => $student->id])}}" method="POST" enctype="multipart/form-data">
										@csrf
                                        @method('put')
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="generation" name="generation"  placeholder="Angkatan : 2017" value="{{ old('generation', $student->generation) }}"  >
