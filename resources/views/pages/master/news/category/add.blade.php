                    ...
                    <div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
                                    <form action="{{ route('master.news.category.store') }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="name">Nama kategori berita</label>
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Nama kategori berita" value="{{ old('name') }}">
