...
class TeacherController extends Controller
{
    ...
    {
        return view('pages.akademik.teacher.index');
    }
    ...
    {
        return view('pages.akademik.teacher.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        $add_user = User::create([
            ...
            'position_id' => 3,
            'email' => $request->email,
            'password' => Hash::make('Password' . $request->nip),
            'is_admin' => 0,
    ...
    {
        return view('pages.akademik.teacher.edit', ['teacher' => $teacher]);
    }
    ...
    public function update(Request $request, Teacher $teacher)
    {
        ...
        if ($insert) {
            Alert::toast('Berhasil Mengubah data guru {{ $request->name }}.', 'success');
        } else {
            Alert::toast('Gagal Mengubah data guru {{ $request->name }}.', 'error');
        }
