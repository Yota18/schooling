...
class AlumniController extends Controller
{
    ...
    {
        return view('pages.akademik.alumni.index');
    }
    ...
    {
        return view('pages.akademik.alumni.add', ['classes' => Classes::where('status', 1)->get()]);
    }
    ...
    {
        return view('pages.akademik.alumni.edit', ['student' => $student, 'classes' => Classes::where('status', 1)->get()]);
    }
